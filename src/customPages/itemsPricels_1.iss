// © _McClayn, 2020-now BASE justsherlock Pricels \\
...
// pricels
// Overcross
Source: "files\mods\pricels\prikolnyj-pritsel-overcross-dlja-world MR_TEZ + Andre_V\mods\1.39.0.0\crosshair_arcade.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels1');
Source: "files\mods\pricels\prikolnyj-pritsel-overcross-dlja-world MR_TEZ + Andre_V\mods\1.39.0.0\crosshair_Controls.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels1');
Source: "files\mods\pricels\prikolnyj-pritsel-overcross-dlja-world MR_TEZ + Andre_V\mods\1.39.0.0\crosshair_sniper.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels1');
...
Source: "files\mods\pricels\prikolnyj-pritsel-overcross-dlja-world MR_TEZ + Andre_V\mods\1.39.0.0\crosshair_strategic.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels1');
Source: "files\mods\pricels\prikolnyj-pritsel-overcross-dlja-world MR_TEZ + Andre_V\mods\1.39.0.0\crosshairs_api_1.1.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels1');
...
// ProTanki New
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Новый прицел OK\mods\1.39.0.0\crosshair_arcade.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_1');
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Новый прицел OK\mods\1.39.0.0\crosshair_sniper.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_1');
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Новый прицел OK\mods\1.39.0.0\crosshairs_api_1.1.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_1');
...
// ProTanki Old
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Старый прицел Карать\mods\1.39.0.0\crosshair_arcade.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_2');
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Старый прицел Карать\mods\1.39.0.0\crosshair_sniper.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_2');
Source: "files\mods\pricels\pritsel-protanki-dlya-world\Старый прицел Карать\mods\1.39.0.0\crosshairs_api_1.1.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels2_2');
...
// BadBoy pricel
Source: "files\mods\pricels\pritsel-bedboya-dlya-world\mods\1.39.0.0\crosshair_arcade.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels3');
Source: "files\mods\pricels\pritsel-bedboya-dlya-world\mods\1.39.0.0\crosshair_sniper.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels3');
Source: "files\mods\pricels\pritsel-bedboya-dlya-world\mods\1.39.0.0\crosshair_strategic.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels3');
Source: "files\mods\pricels\pritsel-bedboya-dlya-world\mods\1.39.0.0\crosshairs_api_1.1.mtmod"; DestDir: "{app}\mods\{#PatchLesta}"; Flags: ignoreversion recursesubdirs createallsubdirs; BeforeInstall: SetInstallStatus('instStatusBase'); Check: ComponentsPricelsChecked('itemPricels3');
