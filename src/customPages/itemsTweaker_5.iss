// © _McClayn, 2020-now BASE justsherlock Tweaker \\
...
begin
  ComponentsPageTweaker := CreateCustomPage(ComponentsPageXVM.ID, '', '');    // here indicate the last Step       ComponentsPageXVM.ID   ComponentsPageVoiceover     --SelectDirPage --ComponentsPageMain ....
