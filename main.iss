// © _McClayn, 2020-now JustSherlock Modpack  BASE \\
...
// for Lesta
#define GameVersionLesta "1.39.0"                             ;  1.39.0  1.38.0  1.37.0  1.36.1  1.34  1.33  1.32  1.28  1.22  1.21.1   1.21
#define PatchLesta "1.39.0.0"                                 ;  1.39.0.0  1.38.0.0  1.37.0.0  1.36.1.0  1.34.0.0  1.33.0.0  1.32.0.0  1.28.0.0  1.21.1.0  1.16.1.0  1.16.0.0  1.15.0.3  1.15.0.3  1.15.0.2  1.15.0.1   1.15.0.0  1.14.1.4  1.14.1.3  1.14.1.2  1.14.1.1   1.14.1.0  1.12.1.1   1.14.0.1    1.14.0.2    1.14.0.3  1.14.0.4  1.14.0.5                   1.11.0.0
// for WG
#define GameVersionWG "1.27.1"                                ;  1.22  1.21.1   1.21
#define PatchWG "1.27.1.0"                                    ;  1.21.1.0  1.16.1.0  1.16.0.0  1.15.0.3  1.15.0.3  1.15.0.2  1.15.0.1   1.15.0.0  1.14.1.4  1.14.1.3  1.14.1.2  1.14.1.1   1.14.1.0  1.12.1.1   1.14.0.1    1.14.0.2    1.14.0.3  1.14.0.4  1.14.0.5                   1.11.0.0
...
#define Version "1.39.02"                                        ;  1.39.01  1.38.03   2.2.01  2.1.03  2.1.02  2.1.01    2.0  1.0   8.0   7.0  6.0  5.0  4.0  3.0  2.0  1.0  4.0  3.0  2.0  1.0  1.0  2.0  8.0  7.0  6.0  5.0  4.0  3.0  2.0  1.0  2.0
...
#include "src\customPages\itemsMain_0.iss"                    ; основные модификации
#include "src\customPages\itemsPricels_1.iss"                 ; прицелы
//#include "src\customPages\itemsHangar.iss"                  ; ангарные моды
#include "src\customPages\itemsVoiceover_2.iss"               ; озвучки экипажа
//#include "src\customPages\itemsBattle.iss"                  ; боевой интерфейс
#include "src\customPages\itemsPMOD_3.iss"                    ; пмод
#include "src\customPages\itemsXVM_4.iss"                     ; хвм
//
#include "src\customPages\itemsTweaker_5.iss"                 ; Tweaker
//
